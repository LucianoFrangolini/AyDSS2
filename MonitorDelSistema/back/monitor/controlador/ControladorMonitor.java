package back.monitor.controlador;
...
/**
 * @author Grupo12<br>
 *         Clase encargada de hacer de intermediaria entre el modelo del monitor
 *         y su parte visual<br>
 *
 */
public class ControladorMonitor implements PropertyChangeListener {
	 ...
	 * @param vista de tipo IVistaMonitor: Representa la visual del monitor.<br>
	 * @param monitor de tipo Monitor: Representa el modelo del monitor.<br>
	 */
