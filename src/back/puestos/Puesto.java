 ...
 * @author Grupo12
 * <br>
 * Clase para un Puesto de trabajo, extiende de ConexionSocket.
 * <br>
 */
public class Puesto extends ConexionSocket {
	 ...
	 * @param numeroPuesto de tipo Integer: representa el numero de puesto que se va a crear.<br>
	 */
	...
	/**
	 * Método que establece una conexion por Socket con un host a traves de un puerto determinado y que puede realizar distintas acciones dependiente del parametro de entrada.<br>
	 * @param accion de tipo String: representa la accion que se quiere realizar..<br>
	 * <b> Post: </b> Se abre un socket para enviar un mensaje y dependiendo el mensaje tambien recibir uno.<br>
	 */
