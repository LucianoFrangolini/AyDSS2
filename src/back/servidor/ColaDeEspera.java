...
public class ColaDeEspera {
	 ...
	 * @return devuelve un String con el dni del proximo cliente en la cola y lo retira de la misma, o null si estaba vacía.<br>
	 */
	...
	/**
	 * Método encargado de revisar si un elemento se encuentra en la cola de espera.<br>
	 * <b> Pre: </b> el String de dni enviado debe ser distinto de null.<br>
	 * @return devuelve true si el elemento se encontraba en la cola, false en caso contrario.<br>
	 */
